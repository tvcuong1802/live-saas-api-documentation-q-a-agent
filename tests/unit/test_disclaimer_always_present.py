...
NORMAL_INPUT = "How do I retrieve multiple records from a kintone app?"
...
REJECTED_INPUT = (
    "How do I retrieve multiple records from a kintone app? Our API key is sk-live-7KpQ2mXvRb"
    "9WcNhLyTdE4Zsa."
)
